...
public class DetailFragment extends Fragment implements ExoPlayer.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            videoPosition = savedInstanceState.getLong("VideoPosition", 0);
        }
        ...
        if(!videoURL.equals("")) {
            prepareVideo(getContext(), videoPosition);
        }
        return v;
    }
    @Override
    ...
    private void prepareVideo(Context c, long position) {
        mediaSession = new MediaSessionCompat(c, DetailFragment.class.getSimpleName());
